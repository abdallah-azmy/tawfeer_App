...
//}
//
//class _classState extends State<Questions>{
//
...
//    };
//    var _data=await Http(_scafold).get("Client/FrequentedQuestions", body, context);
//    if(_data!=null){
...
//      key: _scafold,
//      appBar: AppBar(
//        title: MyText(title: "${tr("questions")}",size: 16,color: MyColors.Primary,),
